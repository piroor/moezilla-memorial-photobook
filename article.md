...
調理場を使わせてもらえる飲食店に例えれば、「使いたければ使っていいよ」とは言われていても、ほとんど説明も無しに新しい食材や調理器具がどんどん増えていくような状況です。
...
MozillaがFirefoxのSpiderMonkeyエンジンで採用したのは、インタープリタでの実行を監視して統計情報を収集し、特に高い頻度で実行される箇所を選択的に高い最適化度合いでコンパイルする「Tracing JIT」方式でした。
